...
0x19, 0xe3, 0xa1, 0x90, 0xa2, 0xb9, 0x73, 0xa3, 0x5c, 0x41, 0xc2, 0x31, 0xf2, 0xf8, 0x2a, 0x94, 
0x93, 0x07, 0x0c, 0xdd, 0x52, 0xae, 0xee, 0x9f, 0x26, 0x40, 0x7c, 0xaf, 0xc6, 0x06, 0x39, 0xf2, 
0x1c, 0x5b, 0xa1, 0x60, 0x0f, 0x4e, 0xe0, 0xab, 0xb9, 0x49, 0x14, 0xb5, 0x21, 0x09, 0x82, 0x5d, 
...
GATT_DATA(const struct bg_gattdb_buffer_with_len	bg_gattdb_data_attribute_field_31 ) = {
	.len=19,
	.data={0x14,0x21,0x00,0xd6,0x58,0xd6,0x21,0xbc,0x55,0x81,0x9f,0x42,0x44,0x71,0x6d,0xc4,0x6e,0xc2,0xfe,}
};
...
GATT_DATA(const struct bg_gattdb_buffer_with_len	bg_gattdb_data_attribute_field_28 ) = {
	.len=19,
	.data={0x08,0x1e,0x00,0x1c,0x5b,0xa1,0x60,0x0f,0x4e,0xe0,0xab,0xb9,0x49,0x14,0xb5,0x21,0x09,0x82,0x5d,}
};
...
GATT_DATA(const struct bg_gattdb_buffer_with_len	bg_gattdb_data_attribute_field_26 ) = {
	.len=19,
	.data={0x0a,0x1c,0x00,0x93,0x07,0x0c,0xdd,0x52,0xae,0xee,0x9f,0x26,0x40,0x7c,0xaf,0xc6,0x06,0x39,0xf2,}
};
GATT_DATA(const struct bg_gattdb_buffer_with_len	bg_gattdb_data_attribute_field_25 ) = {
	.len=16,
	.data={0x19,0xe3,0xa1,0x90,0xa2,0xb9,0x73,0xa3,0x5c,0x41,0xc2,0x31,0xf2,0xf8,0x2a,0x94,}
};
...
GATT_DATA(const struct bg_gattdb_attribute bg_gattdb_data_attributes_map[])={
    ...
    {.uuid=0x8001,.permissions=0x806,.caps=0xffff,.datatype=0x07,.dynamicdata=&bg_gattdb_data_attribute_field_22},
    {.uuid=0x0002,.permissions=0x801,.caps=0xffff,.datatype=0x00,.constdata=&bg_gattdb_data_attribute_field_23},
    {.uuid=0x8002,.permissions=0x806,.caps=0xffff,.datatype=0x07,.dynamicdata=&bg_gattdb_data_attribute_field_24},
    ...
    {.uuid=0x8004,.permissions=0x803,.caps=0xffff,.datatype=0x01,.dynamicdata=&bg_gattdb_data_attribute_field_27},
    {.uuid=0x0002,.permissions=0x801,.caps=0xffff,.datatype=0x00,.constdata=&bg_gattdb_data_attribute_field_28},
    {.uuid=0x8005,.permissions=0x802,.caps=0xffff,.datatype=0x01,.dynamicdata=&bg_gattdb_data_attribute_field_29},
    ...
    {.uuid=0x8007,.permissions=0x804,.caps=0xffff,.datatype=0x02,.dynamicdata=&bg_gattdb_data_attribute_field_32},
    {.uuid=0x000e,.permissions=0x807,.caps=0xffff,.datatype=0x03,.configdata={.flags=0x01,.index=0x08,.clientconfig_index=0x01}},
};
